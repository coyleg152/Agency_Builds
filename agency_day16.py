# File: agency_day16.py
import pygame
from enemies_day17 import PrisonGuard
...
def load_level(filename):
    ...
    for line in level_data:
        ...
        if data[0] == "rect":
            ...
            enemies.append(PrisonGuard(int(data[1]), \
...
while is_running:
    ...
    for enemy in enemies:
        ...
        if y_pos < enemy.y + enemy_height and y_pos + P_HEIGHT > enemy.y:
            if (enemy.direction == -1 and x_pos < enemy.x) \
            or (enemy.direction == 1 \
