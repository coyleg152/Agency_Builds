...
level = []
level.append(pygame.Rect(0, 4 * W_HEIGHT // 5, \
3 * W_LENGTH // 5 + LINE_PX, W_HEIGHT // 5))
level.append(pygame.Rect(3 * W_LENGTH // 5, 3 * W_HEIGHT // 5, \
2 * W_LENGTH // 5, 2 * W_HEIGHT // 5))
level.append(pygame.Rect(0, 0, W_LENGTH // 5 + 3, 4 * W_HEIGHT // 5 + 3))
level.append(pygame.Rect(W_LENGTH // 5, 0, 4 * W_LENGTH // 5, W_HEIGHT // 5))
level.append(pygame.Rect(W_LENGTH // 5, 3 * W_HEIGHT // 5, \
W_LENGTH // 5, W_HEIGHT // 5 + 3))
